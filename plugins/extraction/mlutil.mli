...
val iter_mltyped : (ml_ast -> 'a) -> ml_ast -> 'a
val iter_mltyped_branch : ('a * 'b * ml_ast -> 'c) -> 'a * 'b * ml_ast -> 'c
val map_mltyped : (ml_ast -> ml_ast) -> ml_ast -> ml_ast
val map_mltyped_branch : ('a * 'b * ml_ast -> 'c * 'd * ml_ast) -> 'a * 'b * ml_ast -> 'c * 'd * ml_ast
